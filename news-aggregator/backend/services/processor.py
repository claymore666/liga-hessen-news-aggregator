    ...
    async def extract_topics(self, conversation_messages: list[dict]) -> tuple[str, str | None]:
        ...
        follow_up = {
            ...
            "content": (
                ...
                "Integration, Integrationskurse, Sprachförderung für Migranten\n"
                "- Pflege = Pflegepersonal, Pflegebeitrag, Pflegereform, "
                "auch Demenz und Demenzversorgung\n"
                "- Behinderung und Inklusion = Schwerbehinderung, Behindertenrecht, "
                "Inklusion, Teilhabe, Barrierefreiheit, Eingliederungshilfe, "
                "Bundesteilhabegesetz — auch wenn es um Rente/Kindergeld für Behinderte geht\n"
                "- Wohnen und Wohnungsnot = Wohngeld, Hessengeld, Mietpreisbremse, "
                "Sozialwohnungen, Wohnraumförderung\n"
                "- Armut und Existenzsicherung = Armut, Überschuldung, Schuldnerberatung, "
                "Energiearmut, Tafeln, Existenzsicherung\n"
                ...
                "- 'Schuldnerberatung hilft bei Ueberschuldung' -> Armut und Existenzsicherung\n\n"
